...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'globalZoom',
      title: 'Global Site Zoom (Desktop)',
      description: 'Scales the entire website layout on desktop. 0.8 = 80%, 1.0 = 100%.',
      type: 'number',
      initialValue: 0.8,
    ...
    defineField({
      name: 'globalZoomMobile',
      title: 'Global Site Zoom (Mobile)',
      description: 'Scales the entire website layout on mobile devices (<768px). 1.0 = 100%.',
      type: 'number',
      initialValue: 1.0,
      validation: (Rule) => Rule.min(0.5).max(1.5).precision(2),
      group: 'content',
    ...
    defineField({
      name: 'gridTextScale',
      title: 'Grid Text Scale',
      description: 'Scale factor for typography inside grid items (e.g. 1.0 = 100%, 1.2 = 120%).',
      type: 'number',
      initialValue: 1.0,
